...
// 需要实例化
const cos = new COS({
  SecretId: 'AKIDSjpeDWYKwPo0waxe7KFtGLAhxwd3C4fy',
  SecretKey: '3uUnpa4HCrEK8etrYxB8nBH6dtsa0A2d'
...
export default {
  ...
  computed: {
    // 设定一个计算属性 判断是否已经上传完了一张，关闭上传按钮
    fileComputed() {
      return this.fileList.length === 1
    }
  },
  methods: {
    preview(file) { // 点击预览触发的函数
    ...
    upload(params) {
      if (params.file) {
        ...
        cos.putObject({
          // 配置
          Bucket: 'gao123-1313142343', // 存储桶名称
